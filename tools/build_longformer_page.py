...
<aside class="nav">
  ...
  <div class="box">
    ...
    相关：<a href="../sparse-attention/index.html">稀疏注意力专题</a>
  </div>
</aside>
...
（初始化时让 g 套与 s 套相同，再微调）</div>
  ...
  <div class="refgrid">
    ...
    <div class="ref"><span class="tag">相关</span><h5>稀疏注意力专题</h5><p>把 Longformer 放回窗口 / BigBird / NSA 谱系里对照读。</p><a href="../sparse-attention/index.html">打开专题</a></div>
    <div class="ref"><span class="tag">相关</span><h5>BigBird</h5><p>在局部+全局上加随机块，并讨论万能近似。</p><a href="../bigbird/index.html">精读</a> · <a href="../bigbird/paper.pdf">PDF</a></div>
    <div class="ref"><span class="tag">相关</span><h5>Flash Attention</h5><p>窗口图案可与 Flash 的 window_size 结合做高效实现。</p><a href="../flash-attention/index.html">打开专题</a></div>
  </div>
