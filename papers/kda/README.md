...
> 与 DeltaNet 分开放：理论见 [`../deltanet/`](../deltanet/)（2102.11174），可扩展训练见 [`../deltanet-parallel/`](../deltanet-parallel/)（2406.06484）；本夹是 Kimi 的通道门控升级 + 混合架构。

## 怎么读

1. （建议）[`../deltanet/`](../deltanet/) → [`../deltanet-parallel/`](../deltanet-parallel/) → [`../gated-deltanet/`](../gated-deltanet/) → 本页
...
相关：[DeltaNet 原点](../deltanet/) · [并行训练](../deltanet-parallel/) · [Gated DeltaNet](../gated-deltanet/) · [Linear Attention](../linear-attention/) · [官方 KDA kernel](https://github.com/fla-org/flash-linear-attention/tree/main/fla/ops/kda)
